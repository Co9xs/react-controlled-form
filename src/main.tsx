    ...
    return (
        <div>
          <div style={{background: '#EFEFEF', marginBottom: '30px', padding: '10px'}}>
            ...
            <p style={{margin: "0"}}>状態をuseStateで管理しつつ、onChangeでstateを更新してvalueに反映</p>
          ...
          <div style={{background: '#EFEFEF', marginBottom: '30px', padding: '10px'}}>
            ...
            <p style={{margin: "0"}}>useStateは使わず状態はDOMに持たせたまま、任意のタイミングでrefから値を取り出す（今回はonBlurでconsoleに表示している）</p>
          ...
          <div style={{background: '#EFEFEF', marginBottom: '30px', padding: '10px'}}>
            ...
            <p style={{margin: "0"}}>入力中の状態はDOMに持たせつつ、任意のタイミングでstateに同期（今回はonBlurでstateに同期している）</p>
            <p style={{margin: "0"}}>状態はReactで保持しつつ、再レンダリングが走る回数が少ない分パフォーマンス◯</p>
            <MixedInput/>
          </div>
